...
export function PanelSkeleton({
  ...
  return (
    <div className={cn("flex flex-col gap-4 rounded-2xl border border-border/40 bg-card p-4", className)}>
...
export function KpiCardSkeleton({ size = "default", className }: { size?: "default" | "sm"; className?: string }) {
  const isSm = size === "sm";
  return (
    <div className={cn("flex flex-col gap-3 rounded-2xl border border-border/40 p-4", isSm ? "min-h-[120px] p-3" : "min-h-[168px]", className)}>
