...
describe("buildPrayerConsistencyRows", () => {
  it("builds one row per prayer, one cell per day, defaulting to pending when unlogged", () => {
    const rows = buildPrayerConsistencyRows(PRAYER_ROWS, ["2026-08-14", "2026-08-15"]);
